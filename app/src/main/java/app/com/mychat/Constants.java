...
public class Constants {
   ...
   // public static final String STDBY_SUFFIX = "-stdby";
     public static final String STDBY_SUFFIX = "calling_channel";

    //calling_channel

    public static final String PUB_KEY = "pub-c-60ab2436-b4ca-4921-bb3a-1b94cbd7b2ff"; // Your Pub Key
    public static final String SUB_KEY = "sub-c-f917bc56-8154-11e6-8409-0619f8945a4f"; // Your Sub Key
